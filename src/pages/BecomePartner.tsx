...
export default function BecomePartner() {
  return (
    <div className="bg-white overflow-x-hidden font-poppins">
      ...
      {/* HERO SECTION */}
      <section className="relative bg-white overflow-hidden pt-6 md:pt-16 pb-8 md:pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
          
          {/* Left Text Content */}
          <div className="z-10 text-center md:text-left">
            <h1 className="text-2xl sm:text-3xl md:text-[44px] font-bold text-gray-900 mb-3 md:mb-4 tracking-tight leading-tight">
              Aapki apni finance ki dukaan
            </h1>
            <div className="w-16 h-1 bg-[#4caf50] mb-4 md:mb-6 mx-auto md:mx-0"></div>
          ...
          <div className="relative flex justify-center md:justify-end">
            <img 
              ...
              className="w-full h-auto object-contain max-w-[280px] sm:max-w-[350px] md:max-w-[600px]"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#334155] py-4 md:py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-center gap-3 md:gap-8">
          ...
          <button className="bg-[#00a651] hover:bg-[#008f45] text-white px-6 md:px-10 py-2 md:py-2.5 rounded-full text-sm md:text-[15px] font-semibold transition-all active:scale-95 shadow-md">
      ...
      <section className="py-12 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-xl md:text-[36px] font-bold text-[#1e293b]">
              Aapki apni finance ki dukaan
            </h2>
      ...
      <section className="py-12 md:py-24 bg-slate-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 gap-y-8 md:gap-y-12 gap-x-4 md:gap-x-6 max-w-6xl mx-auto">
            ...
            <StatItem icon={<Smartphone className="w-6 h-6 md:w-10 md:h-10"/>} label="Trisaran mobile app" color="bg-purple-50" />
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-xl md:text-[38px] font-bold text-[#1e293b] mb-3 md:mb-4">
      ...
      <section className="relative overflow-hidden bg-[#f8fafc] py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-xl md:text-[40px] font-bold text-[#1e293b]">
            ...
            <div className="bg-gray-50 p-6 md:p-8 rounded-xl md:rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-500">Trisaran Certified Partner</p>
                </div>
              </div>
            </div>
      ...
      <section className="w-full bg-white py-8 md:py-20 font-poppins">
        <div className="max-w-[95%] mx-auto bg-[#3b4758] rounded-[40px] md:rounded-[80px] relative flex flex-col md:flex-row items-center overflow-hidden py-10 md:py-20">
          ...
          <div className="z-20 w-full md:w-3/5 px-4 md:px-24 flex flex-col items-center md:items-start">
            ...
            <p className="text-white/90 text-sm md:text-[22px] mb-4 md:mb-10 font-normal text-center md:text-left">
              Grow your business. Grow your career
            </p>

            <button className="bg-white text-black px-6 md:px-12 py-2.5 md:py-3 rounded-full text-sm md:text-[17px] font-medium hover:bg-gray-100 transition-all shadow-sm">
              Register Now
            </button>
          </div>
